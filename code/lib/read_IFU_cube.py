def read_IFU_cube(cube, survey, path_cubes):
    ...
    if survey not in ('PMAS', 'MUSE', 'MANGA'): # Add other surveys if desired
        
        raise NameError('Please, analyze a valid survey: PMAS/MUSE/MANGA')
        ...
        if ( ( (survey == 'PMAS') | (survey == 'MANGA') ) & ('resam' in cube) ):        # PMAS/MANGA, resam
        
            Flux = 1.E-16 * Flux                                                        #[1E-16 ergs/cm2/angstrom/sec]
            Error = 1.E-16 * Error                                                      #[1E-16 ergs/cm2/angstrom/sec]
        
        elif ( ( (survey == 'PMAS') | (survey == 'MANGA') ) & ('starsub' in cube) ):    # PMAS/MANGA, starsub
